...
from calc_method.math_ import calc_damage, calc_lower_concentration
...
class Calculation():
    ...
    def get_zone_and_risk_param(self, project_code: str, scenario_number: str, equipment_name: str, equipment_type: Any,
        ...
        :param lower_concentration_limit       - НКПР, об.%
        ...
        r_nkpr, r_flash = calc_lower_concentration.LCLP().lower_concentration_limit(
            mass=mass_in_factor * self.constants.T_TO_KG, molecular_weight=molecular_weight,
            t_boiling=boiling_temperature_liquid,
            lower_concentration=lower_concentration_limit)
        ...
        probability = failure_set.equipment_failure_rates[equipment_type.value]['categories'][model_type][type_accident] * \
                      tree[type_accident][0][tree[type_accident][1].index('flash')]
